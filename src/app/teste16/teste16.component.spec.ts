...
import { Teste16Component } from './teste16.component';

// Estrutura do teste unitário
describe('Testando teste 16', () => {

  // Inicialização
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [Teste16Component]
    }).compileComponents();
  });
  ...
  it('Validar variável nome', () => {
    ...
    // Fixture
    const fixture = TestBed.createComponent(Teste16Component);

    // Obter as variáveis e funções do componente
    const componente = fixture.componentInstance;

    // Validação
    expect(componente.nome).toEqual('Renan');
